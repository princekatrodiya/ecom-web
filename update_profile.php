...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" placeholder="<?= isset($fetch_profile['name']) ? $fetch_profile['name'] : ''; ?>" class="box" maxlength="50">
      <input type="email" name="email" placeholder="<?= isset($fetch_profile['email']) ? $fetch_profile['email'] : ''; ?>" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="number" name="number" placeholder="<?= isset($fetch_profile['number']) ? $fetch_profile['number'] : ''; ?>" class="box" min="0" max="9999999999" maxlength="10">
